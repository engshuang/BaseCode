...
/**
 * The Retailer orders computers from the Vendor by sending a message via the
 * VendorOrderQueue. It then syncronously receives the reponse message and
 * reports if the order was successful or not.
 */
public class Retailer implements Runnable {
	...
	public void run() {
		...
		try {
			...
			Destination vendorOrderQueue = session
					.createQueue("VendorOrderQueue");
